...
exports.sendContactAdminEmail = sendContactAdminEmail;
exports.sendActivationOtpEmail = sendActivationOtpEmail;
...
async function sendContactAdminEmail(opts) {
...
/* ------------------------------------------------------------------ */
async function sendActivationOtpEmail(to, name, role, code) {
...
async function sendWelcomeEmail(to, name, role) {
    const roleLabel = role === "student" ? "Student"
        : role === "lecturer" ? "Lecturer"
            : "Administrator";
    const roleMessage = role === "student"
